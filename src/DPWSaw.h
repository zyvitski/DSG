    ...
    namespace DPW{
        ...
        public:
            DPWSaw():DSG::SignalGenerator(),_register(0){
                DSG::StaticAssertBounds<1, 3,order>();
            }
            DPWSaw(DSG::DSGFrequency const& frequency,DSG::DSGPhase const& offset):DSG::SignalGenerator(frequency,offset),_register(0){DSG::StaticAssertBounds<1, 3,order>();}
            virtual ~DPWSaw(){}
